...
type CreateBreakdownRequest struct {
	MachineId                  uint64                      `json:"machine_id" validate:"required,number,gte=1,exists=breakdowns;id"`
	...
	BreakdownResourcesRequests []BreakdownResourcesRequest `json:"breakdown_resources_requests"`
}

type BreakdownResourcesRequest struct {
