...
type Parameter struct {
	...
	CheckSheetDocumentTemplate *CheckSheetDocumentTemplate `gorm:"many2many:check_sheet_document_templates_parameters;joinForeignKey:CheckSheetDocumentTemplateID;joinReferences:ParameterID"`
